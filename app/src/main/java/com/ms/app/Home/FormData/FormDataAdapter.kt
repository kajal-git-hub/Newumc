...
import com.ms.app.MasterDB.MasterDBHelper.Companion.MASTER_FORM_ID
import com.ms.app.MasterDB.MasterDBHelper.Companion.RESPONSE_ID
import com.ms.app.MasterDB.MasterDBHelper.Companion.STATUS
import com.ms.app.MasterDB.MasterDBHelper.Companion.SYNCED
import com.ms.app.MasterDB.ViewArrayModel
import com.ms.app.R
...
//                            if (imageUrl.contains("/storage")) {
        ...
        for (i in item.keys) {
            if (i == STATUS) {
                if (item[i] == "Draft") {
                    holder.tvSaveDraft.setBackgroundColor(
                        ContextCompat.getColor(
                            context,
                            R.color.yellow
                        )
