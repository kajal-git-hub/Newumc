...
import com.ms.app.JSONModel.SkipLogicModel
import com.ms.app.MasterDB.FormSubmissionData
import com.ms.app.MasterDB.MasterDBHelper
import com.ms.app.R
import com.ms.app.api.ApiConstants
import com.ms.app.api.request.JSONRequest
import com.ms.app.calculateAge
import com.ms.app.changeDateTimeFormat
import com.ms.app.compressImage
import com.ms.app.createFolderInInternalStorage
import com.ms.app.deleteLastUploadedImages
import com.ms.app.getAllFilesInFolder
import com.ms.app.getCurrentDateTime
import com.ms.app.getPathFromUri
import com.ms.app.getPrefIntData
import com.ms.app.isJsonArray
import com.ms.app.isLocalFilePath
import com.ms.app.isValidNumber
import com.ms.app.pathToBitmap
import com.ms.app.saveImage
import com.ms.app.saveImageToInternalStorage
import com.ms.app.setMinMaxValues
import com.ms.app.setPrefIntData
import com.ms.app.utils.EditTextDebounce
import com.ms.app.validateText
...
private val TAG = "EditTabFragment"

class EditTabFragment : Fragment(), OnTabChangedListener {
    ...
    private val folderName: String = "BMSV2EImg"
...
//                        var base64Encoded=convertUrlToBase64(requireContext(),imgUri2.toString())
                        ...
                        lastClickedImageViewTag?.let { tag ->
                            ...
                            clickedImageView?.setImageURI(newImageUri)
                        }
                    }
                }
            }
    ...
    private fun tabChangeLoadData() {
        ...
        jsonObject = JSONObject(EditFormDataActivity.formJsonData)
        ...
        if (sectionPos == endSection - 1) {
            ...
            if (EditTabFragment.sectionPos == 0) {
...
//                    var tvId=generateViewId("label_$childId")
                    ...
                    linearLayoutSection.addView(tvRadio)
                    ...
                    if (optionsList != null) {
                        ...
                        radioButton(optionsList, rg, tableName, childId, skipLogic, tvRadio, value)
                    }
                ...
                "UPLOAD_IMAGE", "CAPTURE_IMAGE" -> {
                    ...
                    linearLayoutSection.addView(linearLayoutRelativeOption)
                    ...
                    if (childObject.has("relativeOptionsLogic")) {
                        if (value.isNotEmpty()) {
                            ...
                            for (j in 0..valueArray.length() - 1) {
                                lastClickedImageViewTag = "image_$childId-$j"
                                lastClickedImageViewTagUri = "$childId$j"
                                if (::imageMutableArr.isInitialized) {
                                    imageMutableArr["$childId$j"] = valueArray.getString(j)
                                }
                                uploadImage(
                                    label,
                                    tableName,
                ...
                "DATE" -> {
                    ...
                    dateSelect(label, tableName, childId, fieldValidations, skipLogic, value)
                }
...
//                    addableDataArr.clear()
                    ...
                    linearLayoutSection.addView(linearLayoutAddable, layoutParamsLl)

                    var relativeOptionsLogic = ""
                    if (childObject.has("relativeOptionsLogic")) {
                        relativeOptionsLogic = childObject.getString("relativeOptionsLogic")
                    }
                    var count = 0
                    ...
                    if (childObject.has("value") && !childObject.get("value").toString()
                        ...
                        try {
                            val value = childObject.get("value")
                            if (value != "") {
                                val valueJSONArray = value as JSONArray
//                            valueJSONArray = childObject.getJSONArray("value")
                            ...
                            Log.e(TAG, "ADDABLE :" + childObject.get("value"))
                        }
                    } else {
                        if (relativeOptionsLogic == "") {
                            addable(
    ...
    private fun validationCheck(
        ...
        if (sectionObject != null) {
            sectionValidationData(sectionObject!!, validationMutableList)
        }
    }
    ...
    fun sectionValidationData(
        ...
        for (j in 0 until childrenArray.length()) {
            ...
            when (childObject.getString("type")) {
                ...
                "ADDABLE" -> {
                    val childId = childObject.getString("id")
                    var addableFlag = initialTimeCheckSkipLogic(childId)
...
//        Log.d(TAG, "inputText: ${etId}")
        ...
        linearLayoutSection.addView(etInputText)
...
//        var tvId=generateViewId("label_$childId")
        ...
        linearLayoutSection.addView(tvInputNumber)
...
//        etInputNumber.tag = childId
        ...
        linearLayoutSection.addView(etInputNumber)
...
//        var tvId=generateViewId("label_$childId")
        ...
        linearLayoutSection.addView(textAreaTV)
...
//        inputTextAreaET(textAreaEt, tableName, childId)
        ...
        linearLayoutSection.addView(textAreaEt)
    }
...
//            radioButton.id = View.generateViewId()
        ...
        linearLayoutSection.addView(radioError)
    ...
    private fun uploadImage(
        ...
        img.setOnClickListener {
            ...
            Log.e("EditFormIntent", chooserIntent.toString())
//            val intent =
...
//                        if (valueArray.getString(relativeOption).contains("/storage__")){
...
//                    if (valueArray.getString(0).contains("/storage__")){
...
//                if (value.contains("/storage__")){
    ...
    private fun dateSelect(
        ...
        linearLayoutSection.addView(textDateEt)
        ...
        linearLayoutSection.addView(dateError)
        val valueRequired = fieldValidations.getBoolean("valueRequired")
...
//        viewDataSetFromDbText(tableName, childId, textDateEt)
    ...
    private fun getCurrentLocation(
        ...
        linearLayoutSection.addView(conLayout)
        ...
        linearLayoutSection.addView(locationError)
...
//        val x = linearLayoutAddableMain.findViewWithTag<Button>("button_addable_${id}")
//        if (x == null) {
        buttonView(
            btn,
            addButtonTitle,
...
//        }
    ...
    private fun addableUploadImage(
        ...
        Log.e("editNo", countAddable.toString())
        val tv = TextView(requireContext())
        tv.tag = "label_$localId-$countAddable"

        tv.text = addableLabel
        ...
        img.layoutParams = layoutParams
        lastClickedImageViewTag = "image_$addableLabel-$countAddable"
        ...
        img.setOnClickListener {
            ...
            lastClickedImageViewTag = "image_$localId-$countAddable"
            lastClickedImageViewTagUri = "$localId-$countAddable"
        ...
        imgError.tag = "error_$addableLabel-$countAddable"
    ...
    private fun inputTextAddable(
        ...
        etInputTextAddable.textSize = 16f
...
//            var localTargetId=customValidation.getString("addable_relation")
    ...
    private fun addableDropDown(
        ...
        tvAddableDropDown.textSize = 18f
...
//            val optionId = i
    ...
    private fun dropDown(
        ...
        linearLayoutSection.addView(tvDropDown, layoutParamsTV)
        ...
        val paddingInPxTB = resources.getDimensionPixelSize(R.dimen.edit_text_padding_TB)
        textSelect.setPadding(paddingInPxSE, paddingInPxTB, paddingInPxSE, paddingInPxTB)
        linearLayoutSection.addView(textSelect)
        ...
        dropDownError.layoutParams = layoutParamsErr
        dropDownError.text = "Please Select Value"
        linearLayoutSection.addView(dropDownError)

        val textSelectId = EditText(requireContext())
        textSelectId.tag = childId
        textSelectId.visibility = View.GONE
        linearLayoutSection.addView(textSelectId)
        ...
        if (options != null && options.size > 0) {
            if (!value.isNullOrBlank() && value != "NULL") {
                ...
                for (i in 0 until retrievedList.length()) {
                    checkSkipLogic(childId, retrievedList.get(i).toString().toString())
...
//                    Log.d(TAG, "dropDown: $childId")
                    ...
                    /*EditFormDataActivity.statesList.forEachIndexed { index, state ->
...
//                            dataArr.add(stateValue.toInt())
    ...
    private fun showDropDownDialog(
        ...
        if (multiSelect) {
            showDropDownMultiSelect(options, selectedData, value)
...
//            checkSkipLogic(childId, textSelectId.text.toString())
//            Log.d(TAG, "showDropDownDialog: JSON="+EditFormDataActivity.formJsonData)
    ...
    private fun checkSkipLogic(childId: String, value: String) {
        if (EditFormDataActivity.allIds.contains(childId)) {
            if (checkIfValueMatched(EditFormDataActivity.formSkipLogics, childId, value)) {
        ...
        if (EditFormDataActivity.visibleLogicAllIds.contains(childId)) {
            if (EditFormDataActivity.visibleLogicManager.checkIfValueMatched(EditFormDataActivity.formVisibleLogics, childId, value)) {
                Log.d(TAG, "Change detected VisibleLogic in: $childId")
                EditFormDataActivity.visibleLogicManager.computeFlagNRefreshSL()
    ...
    private fun updateFieldVisibility() {
        EditFormDataActivity.formSkipLogics.forEach { item ->
            val viewLabel =
    ...
    private fun visibleLogicUpdateFieldVisibility() {
        EditFormDataActivity.formVisibleLogics.forEach { item ->
            val viewLabel =
    ...
    fun saveValueAny(childId: String, checkValue: MutableMap<Int, MutableMap<Int, Any>>) {
        val jsonObjectOld = JSONObject(EditFormDataActivity.formJsonData)
        ...
        EditFormDataActivity.formJsonData = jsonObjectOld.toString()
    }
...
//            dbHelper.updateSubmissionTable(subId, "Saved", jsonRequestArray.toString())
                var insertedId = 0L
                var cursor =
                    dbHelper.getSingleRecord(MasterDBHelper.FORM_SUBMISSION_TABLE_NAME, subId)
                if (cursor.count == 0) {
                    val currentDateTime = getCurrentDateTime()
                    insertedId = dbHelper.insertFormSubmissionData(
                        FormSubmissionData(
                            formId = formId.toInt(),
                            status = MasterDBHelper.SAVED,
                            responseJson = EditFormDataActivity.formJsonData,
                            createdBy = null,
                    ...
                    dbHelper.updateSubmissionTable(
                        ...
                        EditFormDataActivity.formJsonData
                    )
                }


                val jsonString = EditFormDataActivity.formJsonData
                val jsonObject = JSONObject(jsonString)
                val dataArray = jsonObject.getJSONArray("data")

                val values = ContentValues()
                values.put(MasterDBHelper.STATUS, MasterDBHelper.SAVED)
                if (insertedId != 0L) {
                ...
                if (values.size() != 0) {
                    dbHelper.updateSummeryData(
                        tableName = tableName,
                        values,
                        id = EditFormDataActivity.summeryId
                    )
                }
...
//            Log.d(TAG, "getValueForRequest: $jsonRequestArray")
 ...
 //                        }
    ...
    private fun initialTimeCheckVisibleLogic(childId: String): Boolean {
        var fild = EditFormDataActivity.formVisibleLogics.find { it.visibleLogicQ == childId }
        if (fild != null) {
    ...
    private fun initialTimeCheckSkipLogic(childId: String): Boolean {
        var fild = EditFormDataActivity.formSkipLogics.find { it.skipLogicQ == childId }
        if (fild != null) {
            return fild.flag == true
        } else {
            return false
            ...
            if (item.skipLogicQ == targetId) {
                ...
                if (item.skipLogicVal == value) {
                    ...
                    //    Log.d(TAG, "Match Found! IF");
                        ...
                        EditFormDataActivity.formSkipLogics
                    )
                ) {
                    item.flag = true;
    ...
    fun computeFlagNRefreshSL() {
        val previousParentFlags = EditFormDataActivity.formSkipLogics.map { item ->
            SkipLogicModel(
                flag = item.flag,
        ...
        flagComputation(EditFormDataActivity.formSkipLogics)

        val newParentFlags = EditFormDataActivity.formSkipLogics.map { item ->
            SkipLogicModel(
                flag = item.flag,
                skipLogicQ = item.skipLogicQ
            )
        ...
        for (i in EditFormDataActivity.formSkipLogics.indices) {
            if (previousParentFlags[i].flag != newParentFlags[i].flag ||
                ...
                updateFlagById(
                    ...
                    newParentFlags[i].flag == true, EditFormDataActivity.formSkipLogics
                )
