...
import com.ms.app.JSONModel.VisibleLogicModel
import com.ms.app.JSONModel.Data
...
private val TAG = "EditFormDataActivity"
class EditFormDataActivity : AppCompatActivity() {
...
//        try {
            ...
            responseId = intent.getIntExtra("responseId", 0)
            ...
            if (status==MasterDBHelper.SYNCED) {
                ...
                sectionViewModel.getSyncedSchemaValue(token.toString(), formId, responseId)
...
//                        Log.d(TAG, "getSyncedSchemaValue:="+response.data?.body())
                                if (response.data?.body()?.code == 1) {
                                    ...
                                    tbLayout.addOnTabSelectedListener(object :
                                        ...
                                        override fun onTabSelected(tab: TabLayout.Tab) {
                                            ...
                                            val currentFragment =
                                                adapter.getItem(tab.position) as EditTabFragment
               ...
               var formSubmissionData=dbHelper.getSubmissionTableById(subId)
                if (formSubmissionData!=null){
                    ...
                    tbLayout.addOnTabSelectedListener(object : TabLayout.OnTabSelectedListener {
                        ...
                        override fun onTabSelected(tab: TabLayout.Tab) {
                            ...
                            val currentFragment = adapter.getItem(tab.position) as EditTabFragment
                            if (currentFragment.isOnCreatedView) {
                                currentFragment.onTabChanged(tab.position)
                            }
                        }
    ...
    class ViewPagerAdapter(
        ...
        init {
            ...
            jsonData.data?.forEachIndexed { index, data ->
                fragmentList.add(EditTabFragment())
            }
